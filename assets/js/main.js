...
/* Registra callbacks del ticker de GSAP (hero parallax, carrusel). */
function addPageTicker(fn) {
  gsap.ticker.add(fn);
}

/* ── Inicializa las animaciones de contenido de la página ── */
...
/* ── Navegación nativa ──
   ...
   transparente al cambiar de página o idioma. Ahora cada enlace carga la
   página completa (HTML estático + caché de Netlify = instantáneo y robusto)
   y initNav() se reinicializa limpio en cada carga. */
...
function initCitaForm() {
  ...
  const APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbx90NakB4ZR8iw36ch75wAn6eQMjXhXbZKELv1RqUWOv7Uukh5F5xQdyEDu7-KJ0c3k/exec';
